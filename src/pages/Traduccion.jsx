      ...
      <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <p className="text-base text-gray-700 md:text-lg">
            Les damos la bienvenida al subcomité de Traducción
          </p>
        </div>
        <div className="grid gap-10 row-gap-10 lg:grid-cols-3 md:mt-20 sm:mt-10 ">
          <div className="max-w-md sm:mx-auto sm:text-center p-5 shadow-lg rounded-xl hover:shadow-2xl hover:duration-500">
            ...
            <p className="mb-3 text-sm text-left text-gray-900">
              Nuestra responsabilidad es la de ofrecer el apoyo con la atención
              en los idiomas, inglés, alemán y lenguaje de señas, durante el
              recorrido completo de puertas abiertas con fechas y horarios
              específicos. Establecer guardias durante los distintos turnos, por
              si fuera necesario dar esa atención en recorridos fuera de los
              designados.
            </p>
          </div>
          <div className="max-w-md sm:mx-auto sm:text-center p-5 shadow-lg rounded-xl hover:shadow-2xl hover:duration-500">
            ...
            <ul class="max-w-md space-y-1 mb-3 text-sm text-gray-900 list-disc list-inside text-left">
              <li>
                Recibir y acompañar durante el recorrido de puertas abiertas a
                personas que necesiten ser atendidos en otro idioma o lenguaje
                de señas.
              </li>
              <li>
                Disponibilidad para atender a personas que necesiten apoyo en
                recorridos fuera de horarios establecidos, durante turnos
                completos.
              </li>
            </ul>
          </div>
          ...
          <div className="max-w-md sm:mx-auto sm:text-center p-5 shadow-lg rounded-xl hover:shadow-2xl hover:duration-500">
            ...
            <ul class="max-w-md  text-left space-y-1 mb-3 text-sm text-gray-900 list-disc list-inside px-10">
              <li>
                Hombres y mujeres mayores de 18 años con manejo del idioma
                inglés, alemán, lenguaje de señas u otros.
              </li>
              <li>Disponibilidad para cubrir turnos completos de 4 horas.</li>
              <li>
                Experiencia en entablar conversación en los idiomas y habilidad
                mencionados.
              </li>
              <li>Una hermana o hermano por turno.</li>
            </ul>
          </div>
        </div>
