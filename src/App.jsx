...
function App() {
  ...
  return (
    <Routes>
        <Route path="/" element={<Home img={templo} words='Voluntarios para Templo Puebla durante las puertas abiertas' wordSpan='Templo Puebla' className='mb-8 text-5xl font-extrabold leading-none tracking-normal text-gray-900 md:tracking-tight' />} />
